...
//       // 🚀 THE INSTANT STATE FIX: Filter out the wiped images from local memory immediately!
//       setDelivery((prevDelivery) => {
//         if (!prevDelivery) return null
//         return {
//           ...prevDelivery,
//           // Keep only photos whose storageKeys were NOT marked for deletion
//           photos: prevDelivery.photos?.filter((p) => !keysToDelete.includes(p.storageKey)) || []
//         }
//       })

//       // Reset local submission states and pending file arrays
//       setSubmitted(true)
//       setKeysToDelete([])
//       setPhotoFiles([])
//     } catch (err) {
...
//               ⚠️ Lockout Status Enabled: This record has already been invoiced and cannot be modified.
//             </p>
//           </div>
//         )}
